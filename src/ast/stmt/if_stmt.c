...
static void* ast_if_stmt_accept_transformer(void* self_, ast_transformer_t* transformer, void* out);
static void ast_if_stmt_destroy(void* self_);

static ast_node_vtable_t ast_if_stmt_vtable =
{
    .accept = ast_if_stmt_accept,
    .accept_transformer = ast_if_stmt_accept_transformer,
...
{
    ast_if_stmt_t* self = self_;
    return transformer->transform_if_stmt(transformer, self, out);
}
