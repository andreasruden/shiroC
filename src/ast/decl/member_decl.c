...
static void* ast_member_decl_accept_transformer(void* self_, ast_transformer_t* transformer, void* out);
...
static ast_node_vtable_t ast_member_decl_vtable =
{
    ...
    .accept_transformer = ast_member_decl_accept_transformer,
...
{
    ast_member_decl_t* self = self_;
    return transformer->transform_member_decl(transformer, self, out);
}
