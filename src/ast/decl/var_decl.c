...
static void* ast_var_decl_accept_transformer(void* self_, ast_transformer_t* transformer, void* out);
static void ast_var_decl_destroy(void* self_);

static ast_node_vtable_t ast_var_decl_vtable =
{
    .accept = ast_var_decl_accept,
    .accept_transformer = ast_var_decl_accept_transformer,
...
{
    ast_var_decl_t* self = self_;
    return transformer->transform_var_decl(transformer, self, out);
}
