...
static void ast_visitor_visit_import_def(void* self_, ast_import_def_t* import_def, void* out_)
{
    (void)self_;
    (void)import_def;
    (void)out_;
...
static void ast_visitor_visit_uninit_lit(void* self_, ast_uninit_lit_t* uninit_lit, void* out_)
{
    (void)self_;
    (void)uninit_lit;
    (void)out_;
...
static void ast_visitor_visit_inc_dec_stmt(void* self_, ast_inc_dec_stmt_t* inc_dec_stmt, void* out_)
{
    ast_visitor_visit(self_, inc_dec_stmt->operand, out_);
}
