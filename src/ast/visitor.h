...
struct ast_visitor
{
    ...
    // Expressions
    void (*visit_access_expr)(void* self_, ast_access_expr_t* access_expr, void *out_);
    ...
    // Statements
    void (*visit_break_stmt)(void* self_, ast_break_stmt_t* break_stmt, void *out_);
    void (*visit_compound_stmt)(void* self_, ast_compound_stmt_t* compound_stmt, void *out_);
    void (*visit_continue_stmt)(void* self_, ast_continue_stmt_t* continue_stmt, void *out_);
    ...
    void (*visit_for_stmt)(void* self_, ast_for_stmt_t* for_stmt, void *out_);
